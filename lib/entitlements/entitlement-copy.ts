...
export const ENTITLEMENT_COPY: Record<FeatureKey, EntitlementCopyItem> = {
  ...
  financial_subscriptions: {
    title: "Suscripciones financieras en Pro y Plus",
    shortDescription: "Gestiona suscripciones recurrentes con mayor control y seguimiento.",
    blockedMessage: "Las suscripciones financieras están disponibles en Pro y Plus.",
    upgradeBenefit: "Con Pro controlas hasta 10 cargos recurrentes. Con Plus tienes suscripciones financieras ilimitadas.",
    requiredPlanLabel: "MiCuadre Pro",
    icon: "repeat",
  },
  exports: {
    title: "Exportaciones disponibles en Pro y Plus",
    shortDescription: "Exporta tus datos para análisis y respaldo cuando lo necesites.",
    blockedMessage: "La exportación de datos en formato Excel/CSV está disponible en Pro y Plus.",
...
export const BILLING_COPY = {
  ...
  features: {
    genericLocked: "Esta función requiere una cuenta MiCuadre Pro o Plus.",
