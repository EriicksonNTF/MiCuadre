...
interface AccountFilterContentProps {
  ...
  setFilters?: Dispatch<SetStateAction<AccountFilterValues>>
...
export function AccountFilterContent({ filters: _filters, setFilters: _setFilters, accountType }: AccountFilterContentProps) {
  const filters = _filters!
  const setFilters = _setFilters!
  const update = <K extends keyof AccountFilterValues>(key: K, value: AccountFilterValues[K]) => {
  ...
  const showTypeFilter = accountType === "credit"
